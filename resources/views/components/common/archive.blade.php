<div class="row" >
    ...
    @if($current_year && !$current_month && !$current_day)
        <div class="col-12" >
            <x-archive.archive-title :year="$current_year" />
        </div>
    ...
    @if($current_year && $current_month && !$current_day)
        <div class="col-12" >
            <x-archive.archive-title :year="$current_year" :month="$current_month" />
        </div>
    ...
    @if($current_year && $current_month && $current_day)
        <div class="col-12" >
            <x-archive.archive-title :year="$current_year" :month="$current_month" :day="$current_day" />
        </div>
        @if(isset($archive[$current_year][$current_month][$current_day]) && count($paginate) > 0 )
            ...
            <div class="col-12 d-flex justify-content-center">
                <x-common.bootstrap-pagination :paginator="$paginate" />
            </div>
        @else
        <div class="col-12" >
            <p>No posts.</p>
